...
export const getProduct = async (req, res) => {
    try {
        ...
        res.status(500).send(`Error del servidor al consultar producto: ${error}`)
    }
}
export const createProduct = async (req, res) => {
    try {
        ...
        res.status(500).send(`Error del servidor al crear producto: ${error}`)
    }
}
export const updateProduct = async (req, res) => {
    try {
        ...
        res.status(500).send(`Error del servidor al actualizar producto: ${error}`)
    }
...
export const deleteProduct = async (req, res) => {
    try {
        ...
        res.status(500).send(`Error del servidor al eliminar producto: ${error}`)
    }
